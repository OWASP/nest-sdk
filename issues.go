...
func (s *Issues) ListIssues(ctx context.Context, state *components.State, ordering *operations.ListIssuesOrdering, page *int64, pageSize *int64, opts ...operations.Option) (*operations.ListIssuesResponse, error) {
	request := operations.ListIssuesRequest{
		State:    state,
		Ordering: ordering,
		Page:     page,
		PageSize: pageSize,
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PagedIssueSchema
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PagedIssueSchema = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
