...
func newMilestones(rootSDK *Nest, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Milestones {
	return &Milestones{
		rootSDK:          rootSDK,
...
func (s *Milestones) ListMilestones(ctx context.Context, request operations.ListMilestonesRequest, opts ...operations.Option) (*operations.ListMilestonesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v0/milestones/")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PagedMilestone
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PagedMilestone = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Milestones) GetMilestone(ctx context.Context, organizationID string, repositoryID string, milestoneID int64, opts ...operations.Option) (*operations.GetMilestoneResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v0/milestones/{organization_id}/{repository_id}/{milestone_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.MilestoneDetail
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.MilestoneDetail = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
	...
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.MilestoneError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
