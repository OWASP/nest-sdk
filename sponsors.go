...
func newSponsors(rootSDK *Nest, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Sponsors {
	return &Sponsors{
		rootSDK:          rootSDK,
...
// ListSponsors - List sponsors
// Retrieve a paginated list of OWASP sponsors.
func (s *Sponsors) ListSponsors(ctx context.Context, request operations.ListSponsorsRequest, opts ...operations.Option) (*operations.ListSponsorsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/v0/sponsors/")
	if err != nil {
	...
	res := &operations.ListSponsorsResponse{
...
func (s *Sponsors) GetSponsor(ctx context.Context, sponsorKey string, opts ...operations.Option) (*operations.GetSponsorResponse, error) {
	...
	res := &operations.GetSponsorResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
