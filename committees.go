...
func newCommittees(rootSDK *Nest, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Committees {
	return &Committees{
		rootSDK:          rootSDK,
...
func (s *Committees) ListCommittees(ctx context.Context, ordering *operations.ListCommitteesOrdering, page *int64, pageSize *int64, opts ...operations.Option) (*operations.ListCommitteesResponse, error) {
	request := operations.ListCommitteesRequest{
		Ordering: ordering,
		Page:     page,
		PageSize: pageSize,
	}
	...
	res := &operations.ListCommitteesResponse{
...
func (s *Committees) GetCommittee(ctx context.Context, committeeID string, opts ...operations.Option) (*operations.GetCommitteeResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v0/committees/{committee_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
