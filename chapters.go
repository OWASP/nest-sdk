...
func newChapters(rootSDK *Nest, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Chapters {
	return &Chapters{
		rootSDK:          rootSDK,
...
func (s *Chapters) GetChapter(ctx context.Context, key string, opts ...operations.Option) (*operations.GetChapterResponse, error) {
