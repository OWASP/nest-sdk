...
// Generated from OpenAPI doc version 0.2.5 and generator version 2.755.9
...
func New(opts ...SDKOption) *Nest {
	sdk := &Nest{
		SDKVersion: "0.3.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.3.0 2.755.9 0.2.5 github.com/owasp/nest-sdk",
	...
	sdk.Milestones = newMilestones(sdk, sdk.sdkConfiguration, sdk.hooks)
