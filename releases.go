...
func (s *Releases) ListReleases(ctx context.Context, tagName *string, ordering *operations.ListReleasesOrdering, page *int64, pageSize *int64, opts ...operations.Option) (*operations.ListReleasesResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PagedReleaseSchema
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PagedReleaseSchema = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
