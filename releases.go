...
func newReleases(rootSDK *Nest, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Releases {
	return &Releases{
		rootSDK:          rootSDK,
...
func (s *Releases) ListReleases(ctx context.Context, request operations.ListReleasesRequest, opts ...operations.Option) (*operations.ListReleasesResponse, error) {
	...
	res := &operations.ListReleasesResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PagedRelease
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PagedRelease = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Releases) GetRelease(ctx context.Context, organizationID string, repositoryID string, releaseID string, opts ...operations.Option) (*operations.GetReleaseResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v0/releases/{organization_id}/{repository_id}/{release_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetReleaseResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ReleaseDetail
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ReleaseDetail = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
	...
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.ReleaseError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
