...
func newRepositories(rootSDK *Nest, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Repositories {
	return &Repositories{
		rootSDK:          rootSDK,
...
func (s *Repositories) ListRepositories(ctx context.Context, organizationID *string, ordering *operations.ListRepositoriesOrdering, page *int64, pageSize *int64, opts ...operations.Option) (*operations.ListRepositoriesResponse, error) {
	request := operations.ListRepositoriesRequest{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PagedRepository
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PagedRepository = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Repositories) GetRepository(ctx context.Context, organizationID string, repositoryID string, opts ...operations.Option) (*operations.GetRepositoryResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v0/repositories/{organization_id}/{repository_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.RepositoryDetail
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.RepositoryDetail = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
	...
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.RepositoryError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
