...
func (s *Repositories) ListRepositories(ctx context.Context, ordering *operations.ListRepositoriesOrdering, page *int64, pageSize *int64, opts ...operations.Option) (*operations.ListRepositoriesResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PagedRepositorySchema
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PagedRepositorySchema = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
